  ...
  return (
    <div className="flex h-auto bg-pink-200 bg-gray-bg1 rounded-xl">
      <div className="w-full max-w-2xl px-12 py-10 m-auto my-8 bg-white border border-pink-500 rounded-2xl shadow-default">
        <h1 className="mt-4 mb-8 text-3xl font-medium tracking-widest text-center text-pink-500 break-all text-primary">
          {singleArticle.title}
        </h1>
        ...
        <h4 className="mt-4 mb-12 text-xl leading-8 tracking-widest text-left text-pink-400 break-all text-primary">
          {singleArticle.body}
        </h4>
        <button
